...
//    ============================================================================================================
        ...
        @ResponseBody
        public List<ProductManageDTO> HyundaiProducts() {
...
//  ==============================================================================================================
        ...
        @ResponseBody
        public List<ProductManageDTO> hanwhaProducts() {
            return dbService.insuranceProducts();
        }
...
//==================================================================================================================
        ...
        @ResponseBody
        public List<ProductManageDTO> samsungProducts() {
            return dbService.insuranceProducts();
        }
...
//================================================================================================================
        ...
        @ResponseBody
        public List<ProductManageDTO> dbinsProducts() {
            return dbService.insuranceProducts();
        }
...
//====================================================================================================================
        ...
        @ResponseBody
        public List<ProductManageDTO> metlifeProducts() {
            return dbService.insuranceProducts();
        }
...
//=====================================================================================================================
        ...
        @ResponseBody
        public List<ProductManageDTO> hanwhalifeProducts() {
            return dbService.insuranceProducts();
        }
...
//    ==================================================================================================================
        ...
        @ResponseBody
        public List<ProductManageDTO> shinhanProducts() {
            return dbService.insuranceProducts();
        }
...
//====================================================================================================================
        ...
        @ResponseBody
        public List<ProductManageDTO> heungkukProducts() {
            return dbService.insuranceProducts();
        }
...
//======================================================================================================================
        ...
        @ResponseBody
        public List<ProductManageDTO> linaProducts() {
            return dbService.insuranceProducts();
        }
...
//====================================================================================================================
        ...
        @ResponseBody
        public List<CustomerDTO> customerProducts() {
            return dbService.insuranceCustomer();
        }
